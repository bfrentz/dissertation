...
Ultimately, a multichannel $R$-matrix analysis was performed on the all of the present data and was used to extrapolate the astrophysical $S$ factors of these low energies. The present extrapolated zero-energy $S$ factors are $S_{6.79} (0) = 1.24 \pm XX$ keV b, $S_{6.17} (0) = XX \pm XX$ keV b, and $S_{g.s.} (0) = 0.33 \pm XX$ keV b.
